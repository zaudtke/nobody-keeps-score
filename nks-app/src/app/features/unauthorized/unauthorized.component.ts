...
@Component({
  ...
  template: `
    ...
    <!-- Centred content -->
    <div
      class="relative flex-1 flex flex-col items-center justify-center px-5 py-6 text-center overflow-hidden"
    >
      <!-- Ruby glow -->
      <div
      ...
      <h1
        class="font-display text-[1.25rem] font-bold tracking-[-0.02em] leading-[1.1] mb-2.5 relative
      ...
      <p
        class="text-[0.78rem] leading-[1.6] font-normal mb-7 relative max-w-60
      ...
      <!-- NKS signature -->
      <div
        class="absolute bottom-7 left-0 right-0 text-center font-display text-[0.68rem] font-light italic tracking-[0.03em]
